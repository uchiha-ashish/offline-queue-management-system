...
import { Avatar, Wordmark } from './frames.jsx';
...
function OutputCore({ waitMin, rank, statusText = "You're on track" }) {
  return (
    <div>
    ...
    return (
      <KioskShell>
        <div className="k-pad" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', paddingTop: 70 }}>
          ...
          <button className="k-btn k-btn--primary" style={{ marginTop: 30 }} onClick={() => { setName(''); setDigits(''); go('idle'); }}>
      ...
      <KioskShell onBack={() => go('idle')}>
        <div className="k-pad">
          ...
          <div style={{ display: 'flex', gap: 16, marginTop: 26 }}>
            ...
            <button className="k-btn k-btn--primary" style={{ flex: 1, fontSize: 19 }} onClick={() => { setName(''); setDigits(''); go('idle'); }}>
    ...
    return (
      <KioskShell>
        <div className="k-pad" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', paddingTop: 80 }}>
          ...
          <button className="k-btn k-btn--primary" style={{ marginTop: 38 }} onClick={() => { setName(''); setDigits(''); go('idle'); }}>Got it</button>
        </div>
      </KioskShell>
    );
  }

  // ---- WELCOME BACK (pre-booked) ----
  if (route === 'prebooked') {
    return (
      <KioskShell onBack={() => go('phone')}>
        <div className="k-pad">
          ...
          <OutputCore waitMin={4} rank={1} statusText="Your slot is on track" />
          ...
          <button className="k-btn k-btn--primary" style={{ marginTop: 26 }} onClick={() => { setDigits(''); go('idle'); }}>I'll wait here</button>
        </div>
      </KioskShell>
    );
  }
    ...
    return (
      <KioskShell onBack={() => go('phone')}>
        <div className="k-pad">
          ...
          <OutputCore waitMin={28} rank={4} statusText="Ready when you are" />
          <div style={{ display: 'flex', gap: 16, marginTop: 38 }}>
            <button className="k-btn k-btn--ghost" style={{ flex: 1 }} onClick={() => { setDigits(''); go('idle'); }}>Not now</button>
    ...
    return (
      <KioskShell onBack={() => go('idle')}>
        <div className="k-pad">
          ...
          <button className="k-btn k-btn--primary" style={{ marginTop: 26 }} onClick={() => { setDigits(''); go('idle'); }}>Done</button>
        </div>
      </KioskShell>
    );
  }
      ...
      <KioskShell onBack={() => go('cancel')}>
        <div className="k-pad" style={{ paddingTop: 50 }}>
          ...
          <div style={{ display: 'flex', gap: 16 }}>
            <button className="k-btn k-btn--ghost" style={{ flex: 1 }} onClick={() => { setDigits(''); go('idle'); }}>Keep it</button>
