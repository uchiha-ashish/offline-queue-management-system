...
import { Avatar } from './frames.jsx';
import { INITIAL_QUEUE, CALLBACK_TASKS, COACHES, FLOOR_QUEUES, ACTIVITY_LOG, COMM_LOG } from './data.jsx';
...
export default function CoachApp() {
  const [route, setRoute] = useState('floor');
  ...
  const [tasks, setTasks] = useState(CALLBACK_TASKS);
  ...
  if (route === 'floor') {
    return (
      <div className="coach-main" style={{ padding: '24px 28px 40px', minHeight: '100vh' }}>
        <CoachToast toast={toast} />
        <div className="coach-head">
          <div>
            <div className="coach-ttl ttl">Floor overview</div>
            <div className="sub">Bandra Store · Thursday, 5 June · 11:48 AM · 3 coaches on floor</div>
          </div>
        </div>
        <div className="stat-row">
          ...
          <div className="stat"><div className="n red" style={{ cursor: 'pointer' }} onClick={() => setRoute('callbacks')}>{tasks.filter(t => !t.done).length}</div><div className="l">Call-backs due</div></div>
        </div>
            ...
            <div key={co.id} className="floor-col">
              <div className="ch">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8 }}>
                  ...
                  <button className="cbtn cbtn--primary" style={{ fontSize: 12, padding: '7px 12px' }} onClick={() => setRoute('dashboard')}>
                    View queue <Icon name="arrowRight" size={13} />
                  </button>
                </div>
              </div>
              <div className="cq">
  ...
  if (route === 'callbacks') {
    ...
    return (
      <div className="coach-main" style={{ minHeight: '100vh' }}>
        <CoachToast toast={toast} />
        <div className="coach-head">
          <div>
          ...
          <button className="cbtn cbtn--lg" onClick={() => setRoute('floor')}><Icon name="arrowLeft" size={16} /> Back to overview</button>
        </div>
        {open.length === 0 && (
  ...
  // ===== DASHBOARD =====
  return (
    <div className="coach" style={{ height: '100vh' }}>
      <CoachToast toast={toast} />
      <div className="coach-main">
        <div className="coach-head">
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <button className="cbtn cbtn--lg" onClick={() => setRoute('floor')}><Icon name="grid" size={16} /> Back to overview</button>
          </div>
        </div>
